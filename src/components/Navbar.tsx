...
const Navbar = () => {
  ...
  return (
    <>
      ...
      {/* Drawer/Sidebar */}
      <div
        className={`fixed top-14 right-0 h-[calc(100vh-3.5rem)] w-full sm:w-80 bg-white shadow-lg transform ${
          drawerOpen ? 'translate-x-0' : 'translate-x-full'
        } transition-transform duration-300 ease-in-out z-40 sm:rounded-l-2xl`}
      >
        <div className="py-4">
